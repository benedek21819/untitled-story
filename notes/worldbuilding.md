...
Consistency ledger. Add entries as decisions get made.
...
Reincarnation out of a dying era was available **only to those at the very top**. The
survivors are all absolute beings.

This era will also end. Nobody in the story is thinking about that yet.

## Absolute beings

**Killing an absolute being is nearly impossible, regardless of how strong the killer
is.** This is why an entire era of enemies never removed the protagonist — not
because he outmatched all of them, but because the category resists death.

Consequences:

- The old era's top was effectively permanent. Feuds ran for millennia because nobody
  could end one.
...
- The window closes as they climb. The smart play for everyone is to find the others
  *now*, while killing is still cheap.
...
survivor begins with a blank slate. No cosmic retribution is coming for anything any
of them did.
...
— a listener cannot flip back, and TTS will guess inconsistently at invented names.
